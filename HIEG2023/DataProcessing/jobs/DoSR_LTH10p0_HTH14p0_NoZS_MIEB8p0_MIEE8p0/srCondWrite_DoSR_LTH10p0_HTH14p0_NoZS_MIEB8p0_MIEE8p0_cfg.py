...
process.CondDBCommon.connect = 'sqlite_file:EcalSRSettings_DoSR_LTH10p0_HTH14p0_NoZS_MIEB8p0_MIEE8p0.db'
...
process.writeInDB.trigPrimBypass = cms.bool(True)
process.writeInDB.trigPrimBypassMode = cms.int32(1)
process.writeInDB.trigPrimBypassHTH = cms.double(14.0)
process.writeInDB.trigPrimBypassLTH = cms.double(10.0)
