...
process.ecalSelectiveReadoutValidation.outputFile = 'srvalid_Run362315_DoSR_LTH4p0_HTH8p0_DoZS_MIEB8p0_MIEE8p0_HIEB2p5_HIEE3p0_CenterTow0.root'
...
process.TFileService = cms.Service("TFileService",
                                fileName = cms.string("srvalid_Run362315_DoSR_LTH4p0_HTH8p0_DoZS_MIEB8p0_MIEE8p0_HIEB2p5_HIEE3p0_CenterTow0.root"))
...
process.GlobalTag.toGet = cms.VPSet(
 cms.PSet(record = cms.string("EcalSRSettingsRcd"),
   ...
   connect = cms.string("sqlite_file:EcalSRSettings_DoSR_LTH4p0_HTH8p0_DoZS_MIEB8p0_MIEE8p0_HIEB2p5_HIEE3p0_CenterTow0.db")
 )
)
