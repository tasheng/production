...
process.CondDBCommon.connect = 'sqlite_file:EcalSRSettings_DoSR_LTH4p0_HTH8p0_DoZS_MIEB8p0_MIEE8p0_HIEB2p5_HIEE3p0_CenterTow0.db'
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    toPut = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('EcalSRSettings_DoSR_LTH4p0_HTH8p0_DoZS_MIEB8p0_MIEE8p0_HIEB2p5_HIEE3p0_CenterTow0')
    ))
)
...
# ZS energy threshold in GeV to apply to low interest channels of barrel
process.writeInDB.ebDccAdcToGeV = cms.double(0.035)
process.writeInDB.srpBarrelLowInterestChannelZS = cms.double(8.0*0.035) 

# ZS energy threshold in GeV to apply to low interest channels of endcap
process.writeInDB.eeDccAdcToGeV = cms.double(0.06)
process.writeInDB.srpEndcapLowInterestChannelZS = cms.double(8.0*0.06)
...
process.writeInDB.trigPrimBypass = cms.bool(True)
process.writeInDB.trigPrimBypassMode = cms.int32(1)
process.writeInDB.trigPrimBypassHTH = cms.double(8.0)
process.writeInDB.trigPrimBypassLTH = cms.double(4.0)


process.writeInDB.srpBarrelHighInterestChannelZS = cms.double(2.5*0.035)
process.writeInDB.srpEndcapHighInterestChannelZS = cms.double(3.0*0.06)

process.writeInDB.actions = cms.vint32(1, 2, 2, 3, 5, 6, 6, 7)
